...
const apps = {
    ...
    estudos: new Application('Estudos', 'src/folder-estudios.webp', 'apps/estudos.html'),
    projects: new Application('Projectos', 'src/folder-projects.webp ', 'apps/projects.html'),
